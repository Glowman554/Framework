package de.toxicfox.framework.data;
...
public class EnglishLanguageGenerator extends LanguageGenerator {
    ...
    public void generateTranslations() {
        ...
        addTranslation("key.category.minecraft.framework-misc", "Framework miscellaneous");
        addTranslation("key.category.minecraft.framework-mods", "Framework modifications");
        ...
        addTranslation("key.category.minecraft.framework-commands", "Command shortcuts");
